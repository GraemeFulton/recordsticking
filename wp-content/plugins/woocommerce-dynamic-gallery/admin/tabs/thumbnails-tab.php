...
<?php
/*-----------------------------------------------------------------------------------
WC Dynamic Gallery Thumbnails Tab
...
class WC_Dynamic_Gallery_Thumbnails_Tab extends WC_Dynamic_Gallery_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wc_dgallery_thumbnails_tab_manager',
		);
...
global $wc_dgallery_thumbnails_tab;
$wc_dgallery_thumbnails_tab = new WC_Dynamic_Gallery_Thumbnails_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_dgallery_thumbnails_tab_manager() {
	global $wc_dgallery_thumbnails_tab;
	$wc_dgallery_thumbnails_tab->tab_manager();
}
