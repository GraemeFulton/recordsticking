...
<!--            </div>    -->
            <form name="frmDesign" id="frmDesignUpload" action="" method="post" enctype="multipart/form-data">
                <div class="ctColumn1">
                    <div class="blackify" style=" height:40px; font-size: 14px; width:670px; margin-top:6px;">
                        ...
                        <div class="ctColumn1Options" style="width:276px; padding-top:13px;">
                            <label style="text-decoration:blink; color:#CCCCCC; font-weight:bold; font-size:12px;">Total cost for custom design is <?php echo '$'.$_GET['custom_price'];?>. </label>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="ctSubCol1">
                        <div class="blackify ctSubCol1Text" >
                            ...
                            <div id="controlText">
                                <div style="float: left; width: 30px; height: 30px; margin-top: 15px; margin-left:5px;">Text</div>
                                ...
                                <br />
                                            <div id="s1" style="float: left; margin-left: 5px;">Font</div>
                        ...
                        <div class="blackify ctSubCol2Position" style="height: 135px; width:222px; overflow: hidden; float: left; margin-left:6px;">
                            ...
                            <div style="padding-left:5px;">Position</div>
                            <table width="100%" style="margin:0px; text-align:center;" align="center">
                                ...
                                <td><div style="padding-left: 1px; margin-top: 10px;" id="spos3" onmouseover="this.style.cursor='pointer'" onclick="jsTogglePos(3,<?php echo $design_padding_top;?>); setting_position(3);"> <img src="img/shirtposchestright-tshirt.gif">
                                    ...
                                    <div style="text-align:center; margin-left: 0px; margin-top:18px; font-size: 10px;">Top Right </div>
                                    </div></td>
                                <td><div style="margin-left:10px; margin-top: 10px;" id="spos2" onmouseover="this.style.cursor='pointer'" onclick="jsTogglePos(2,<?php echo $design_padding_top;?>);setting_position(2);"> <img src="img/shirtposcentre-tshirt.gif">
                                    <div style="margin-left: 17px; margin-top:-12px;"> </div>
                                    <div style="text-align:center; margin-left: 0px; margin-top:18px; font-size: 10px;">Centre</div>
                                    </div></td>
                                <td><div style="margin-left:10px; margin-top: 10px;" id="spos1" onmouseover="this.style.cursor='pointer'" onclick="jsTogglePos(1,<?php echo $design_padding_top;?>); setting_position(1);"> <img src="img/shirtposchestleft-tshirt.gif">
                                    <div style="margin-left: 17px; margin-top:-12px;"> </div>
                                    <div style="text-align:center; margin-left: 0px; margin-top:18px; font-size: 10px;">Top Left</div>
                                    </div></td>
                                </tr>
                            </table>
                            </div>
                    ...
                    <div class="ctSubCol2">
                        ...
                        <div class="blackify csPreviewHolder" >
                            <div id="dFrontpreview"><span style="padding-left:5px; font-size:14px;">Preview</span>
                        ...
                        <div class="blackify ctSubCol2ShirtPreview" style="height:268px; width:222px; float:left; margin-left: 6px;">
                            <div> <span style="padding-left:5px; font-size:14px;">Design Preview</span>
                                    <?php
                                    $ab_path= ABSPATH; 
                        ...
                        <div align="right">
                        	<div style="float:left; width:65%;height:28px;">
                            	...
                            	<table>
                                	<tr>
                                        ...
                                        ?>
                                    	<td id="attr_name_<?php echo $i;?>" style="font-size:14px; color:#000000;"><?php echo $value->names;?></td>
                                        <?php 
                        	...
                        	<div style="float:left;">
                                <div style="float: left;"><span style="font-size:14px; color:#000000;">Quantity:</span><span style="padding-left:5px;"><input type="text" style="width:40px;" name="qty" id="qty" onkeyup="ValueCheck(this.value);" value="1"></input></span></div>  
                                <div style="float: left; margin-left:20px;"><a class="btnstyle" style="color:<?php echo'#'.$setting_result['cart_color'];?>;" href="javascript:void(0);" onclick="saveDesign(<?php echo $_GET['product_id'];?>,<?php echo $_REQUEST['Vids'];?>,<?php echo count($variations_array);?>)"><span><?php echo ucfirst($setting_result['cart_text']);?></span></a></div>
                                <div style="clear: both;"></div>
                        	</div>
                            <div style="clear: both;"></div>
                        </div>
...
.btnstyle{
border:1px solid #25729a; -webkit-border-radius: 3px; -moz-border-radius: 3px;border-radius: 3px;font-size:12px;font-family:arial, helvetica, sans-serif; padding: 2px 16px 2px 16px; text-decoration:none; display:inline-block;text-shadow: 1px 1px 0 rgba(0,0,0,0.3);font-weight:bold; color: #FFFFFF;
