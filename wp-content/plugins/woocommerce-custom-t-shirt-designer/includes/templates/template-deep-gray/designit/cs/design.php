                    ...
                    <div class="ctSubCol2">
                        ...
                        <div align="right">
                        	<div style="float:left; width:65%;height:28px;">
                            	...
                            	<table>
                                	<tr>
                                        ...
                                        ?>
                                    	<td id="attr_name_<?php echo $i;?>" style="font-size:14px;"><?php echo $value->names;?></td>
                                        <?php 
                        	...
                        	<div style="float:left;">
                                <div style="float: left;"><span style="font-size:14px;">Quantity:</span><span style="padding-left:5px;"><input type="text" style="width:40px;" name="qty" id="qty" onkeyup="ValueCheck(this.value);" value="1"></input></span></div>  
