...
<!--            </div>    -->
            <form name="frmDesign" id="frmDesignUpload" action="" method="post" enctype="multipart/form-data">
                <div class="ctColumn1">
                    <div class="blackify" style=" height:40px; font-size: 13px; width:670px; margin-top:6px; font-weight:bold;">
                        ...
                        <div class="ctColumn1Options" style="width:276px; padding-top:13px;">
                            <label style="text-decoration:blink; color:#FFFFFF; font-weight:bold; font-size:13px;">Total cost for custom design is <?php echo '$'.$_GET['custom_price'];?>. </label>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="ctSubCol1">
                        <div class="blackify ctSubCol1Text" >
                            ...
                            <div id="controlText">
                                <div style="float: left; width: 30px; height: 30px; margin-top: 15px; margin-left:5px; font-size:13px; font-weight:bold;">Text</div>
                                ...
                                <div>
                                    <fieldset>
                                        <legend style="font-size:13px; font-weight:bold;">Color</legend>
                                        <div>
                                ...
                                <br />
                                            <div id="s1" style="float: left; margin-left: 5px;font-size:13px; font-weight:bold;">Font</div>
                        ...
                        <div class="blackify ctSubCol2Position" style="height: 135px; width:222px; overflow: hidden; float: left; margin-left:6px;">
                            ...
                            <div style="padding-left:5px; font-size:13px; font-weight:bold;">Position</div>
                    ...
                    <div class="ctSubCol2">
                        ...
                        <div class="blackify csPreviewHolder" >
                            <div id="dFrontpreview"><span style="padding-left:5px; font-size:13px; font-size:13px; font-weight:bold;">Preview</span>
                        ...
                        <div class="blackify ctSubCol2ShirtPreview" style="height:268px; width:222px; float:left; margin-left: 6px;">
                            <div> <span style="padding-left:5px; font-size:13px; font-size:13px; font-weight:bold;">Design Preview</span>
                                    <?php
                                    $ab_path= ABSPATH; 
                        ...
                        <div align="right">
                        	...
                        	<div style="float:left;">
                                <div style="float: left;"><span style="font-size:13px; color:#000000; font-weight:bold;">Quantity:</span><span style="padding-left:5px;"><input type="text" style="width:40px;" name="qty" id="qty" onkeyup="ValueCheck(this.value);" value="1"></input></span></div>  
