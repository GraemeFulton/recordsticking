...
<!--            </div>    -->
            <form name="frmDesign" id="frmDesignUpload" action="" method="post" enctype="multipart/form-data">
                <div class="ctColumn1">
                    <div class="blackify" style=" height:40px; font-size: 13px; width:670px; margin-top:6px; font-weight:bold; color:#000000;">
                        ...
                        <div class="ctColumn1Options" style="width:276px; padding-top:13px;">
                            <label style="text-decoration:blink; color:#000000; font-weight:bold; font-size:13px;">Total cost for custom design is <?php echo '$'.$_GET['custom_price'];?>. </label>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="ctSubCol1">
                        <div class="blackify ctSubCol1Text" >
                            ...
                            <div id="controlText">
                                <div style="float: left; width: 30px; height: 30px; margin-top: 15px; margin-left:5px; font-size:13px; font-weight:bold; color:#000000;">Text</div>
                                ...
                                <div>
                                    <fieldset>
                                        <legend style="font-size:13px; font-weight:bold; color:#000000;">Color</legend>
                                        <div>
                                ...
                                <br />
                                            <div id="s1" style="float: left; margin-left: 5px;font-size:13px; font-weight:bold; color:#000000;">Font</div>
                        ...
                        <div class="blackify ctSubCol2Position" style="height: 135px; width:220px; overflow: hidden; float: left; margin-left:6px;">
                            <div id="posHolder"> <img src="img/blank.gif" id="posDisable" style="position: absolute; height: 125px; width: 255px; display: none;">
                            <div style="padding-left:5px; font-size:13px; font-weight:bold; color:#000000;">Position</div>
                            <table width="100%" style="margin:0px; text-align:center;" align="center">
                                ...
                                <td><div style="padding-left: 1px; margin-top: 10px;" id="spos3" onmouseover="this.style.cursor='pointer'" onclick="jsTogglePos(3,<?php echo $design_padding_top;?>); setting_position(3);"> <img src="img/shirtposchestright-tshirt.gif">
                                    ...
                                    <div style="text-align:center; margin-left: 0px; margin-top:18px; font-size: 10px; color:#000000;">Top Right </div>
                                    </div></td>
                                <td><div style="margin-left:10px; margin-top: 10px;" id="spos2" onmouseover="this.style.cursor='pointer'" onclick="jsTogglePos(2,<?php echo $design_padding_top;?>);setting_position(2);"> <img src="img/shirtposcentre-tshirt.gif">
                                    <div style="margin-left: 17px; margin-top:-12px;"> </div>
                                    <div style="text-align:center; margin-left: 0px; margin-top:18px; font-size: 10px; color:#000000;">Centre</div>
                                    </div></td>
                                <td><div style="margin-left:10px; margin-top: 10px;" id="spos1" onmouseover="this.style.cursor='pointer'" onclick="jsTogglePos(1,<?php echo $design_padding_top;?>); setting_position(1);"> <img src="img/shirtposchestleft-tshirt.gif">
                                    <div style="margin-left: 17px; margin-top:-12px;"> </div>
                                    <div style="text-align:center; margin-left: 0px; margin-top:18px; font-size: 10px; color:#000000;">Top Left</div>
                                    </div></td>
                                </tr>
                            </table>
                            </div>
                    ...
                    <div class="ctSubCol2">
                        ...
                        <div class="blackify csPreviewHolder" >
                            <div id="dFrontpreview"><span style="padding-left:5px; font-size:13px; font-size:13px; font-weight:bold; color:#000000;">Preview</span>
                        ...
                        <div class="blackify ctSubCol2ShirtPreview" style="height:268px; width:220px; float:left; margin-left: 6px;">
                            <div> <span style="padding-left:5px; font-size:13px; font-size:13px; font-weight:bold; color:#000000;">Design Preview</span>
                                    <?php
                                    $ab_path= ABSPATH; 
                        ...
                        <div align="right">
                        	<div style="float:left; width:65%;height:28px;">
                            	...
                            	<table>
                                	<tr>
                                        ...
                                        ?>
                                    	<td id="attr_name_<?php echo $i;?>" style="font-size:13px; color:#000000; font-weight:bold;"><?php echo $value->names;?></td>
                                        <?php 
                        	...
                        	<div style="float:left;">
                                <div style="float: left;"><span style="font-size:13px; color:#000000; font-weight:bold;">Quantity:</span><span style="padding-left:5px;"><input type="text" style="width:40px; height:12px;" name="qty" id="qty" onkeyup="ValueCheck(this.value);" value="1"></input></span></div>  
...
<style type="text/css">
  .btnstyle{
border:1px solid #b7b7b7; -webkit-border-radius: 3px; -moz-border-radius: 3px;border-radius: 3px;font-size:12px;font-family:arial, helvetica, sans-serif; padding:2px 16px 2px 16px;; text-decoration:none; display:inline-block;text-shadow: 1px 1px 0 rgba(252,252,252,0.3);font-weight:bold; color: #030303;
